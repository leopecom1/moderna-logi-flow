...
CREATE TABLE public.accounts_receivable (
    ...
    days_since_last_sale INTEGER, -- calculated manually, not generated
...
BEGIN
    ...
    IF last_sale IS NOT NULL THEN
        days_since_sale := DATE_PART('day', NOW() - last_sale)::INTEGER;
    ELSE
    ...
    INSERT INTO public.accounts_receivable (
        ...
        last_sale_date, last_collection_date, days_since_last_sale
    ) VALUES (
        customer_uuid, total_sales_amount, total_collections_amount,
        last_sale, last_collection, days_since_sale
    )
